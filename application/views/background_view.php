		...
		<section id="speakers-details">
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-8">
						<div class="details">
							<h2>Conference Backgrounds</h2>
							<p style="text-align: justify"><?= $about_desc; ?></p>
              <br>
              <h2>Conference Objectives</h2>
              <p>1)	Creating a forum to share knowledge, experience and the latest innovations in a accounting, law, and sociology.</p>
              <p>2)	Encourage cross-disciplinary collaboration to overcome challenges complex in business practices, legal regulations, and social dynamics.</p>
              <p>3)	Building a strong professional network between academics, practitioners, and others stakeholders in these three areas.</p>
              <br>
              <div class="social">
