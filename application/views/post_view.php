...
<head>
  ...
  <title><?php echo $judul; ?> | Road to International Symposium</title>
  <meta name="description" content="<?php echo $meta_description; ?> etc." />
  <meta content="" name="keywords">
    ...
    <meta property="og:description" content="<?php echo $meta_description; ?>, etc." />
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6">
            <a class="articles-card" href="<?php echo site_url('post/' . $row->post_slug); ?>" title="">
              <div class="hotel">
                <div class="hotel-img">
                  <img src="<?php echo base_url() . 'assets/backend/images/thumb/' . $row->post_image; ?>" alt="Hotel 1"
                    class="img-fluid">
                </div>
                <h3><a href="<?= site_url('post/' . $row->post_slug); ?>"><?php echo $row->post_title; ?></a></h3>
                <div class="stars">
                  <i class="bi bi-person-circle"> <?php echo $row->user_name; ?></i>
                </div>
                <div class="date">
                  <p> <?php echo date('d M Y', strtotime($row->post_date)); ?> | <a href="javascript:void(0)"></a>
