				...
				<div class="row">
					...
					<div class="col-md-8">
						<div class="details">
							...
							<h2>Co Host</h2>
                            <p>Universities under the Nahdlatul Ulama Higher Education Institution (LPTNU) amounting to Rp. 750.000. Benefits obtained: 5 papers and 2 reviewers.<br>
                            Universities outside LPTNU amounting to Rp. 1.000.000. Benefits obtained: 5 papers and 2 reviewers.</p>

                            <h2>Individual</h2>
                            <p>Individual: participants who register individually for IDR. 200.000 for 1 paper</p>

                            <h2>Payment Account</h2>
                            <p>BANK BNI 1207677083 a.n UNUSIA JAKARTA UNIV
                            Contact Confirmation: Habsyah Fitri Aryani, M.Ak <a href="https://wa.me/6285230686685">(085230686685)</a></p><br>
