				...
				<div class="row">
					...
					<div class="col-md-8">
						<div class="details">
							...
							<!--<p>The Committee will send an e-mail notification to the presenting author on <b>Saturday, July 31, 2021</b>. Only the person listed as the presenting author will receive this notification.</p>-->
       <!--                     <p>#ForYourInformation #InternationalSymposium</p><br>-->
                            <!-- <iframe src="https://drive.google.com/file/d/1z1YNHjTsIzBINZ9DU5MHSo9cN4fIHXkB/preview" width="100%" height="580" allow="autoplay"></iframe><br><br> -->

                            <div class="social">
								<a href="https://pmb.unusia.ac.id"><i class="bi bi-twitter"></i></a>
								<a href="https://pmb.unusia.ac.id"><i class="bi bi-facebook"></i></a>
								<a href="https://pmb.unusia.ac.id"><i class="bi bi-instagram"></i></a>
								<a href="https://pmb.unusia.ac.id"><i class="bi bi-linkedin"></i></a>
							</div>
						</div>
					</div>
