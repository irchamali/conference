		...
		<section id="schedule" class="section-with-bg">
			<div class="container" data-aos="fade-up">
				...
				<ul class="nav nav-tabs" role="tablist" data-aos="fade-up" data-aos-delay="100">
					<!-- <li class="nav-item">
						<a class="nav-link" href="#day-1" role="tab" data-bs-toggle="tab">Pre</a>
					</li> -->
					<li class="nav-item">
						<a class="nav-link active" href="#day-2" role="tab" data-bs-toggle="tab">Day 1</a>
					</li>
					<li class="nav-item">
				...
				<div class="tab-content row justify-content-center" data-aos="fade-up" data-aos-delay="200">
					...
					<div role="tabpanel" class="col-lg-9  tab-pane fade show active" id="day-2">
						...
						<div class="row schedule-item">
							...
							<div class="col-md-12 text-center"><time>Wednesday, 21 August 2024</time>
						...
						<div class="row schedule-item">
							...
							<div class="col-md-10">
								...
								<p>Minister of Education and Culture<br>>> {[person]}</p><br>
								<p>Chaiperson of PBNU (Central Board of Nahdlatul Ulama)<br>>> {[person]}</p><br>
								<p>Rector of UNUSIA Jakarta <br>>> {[person]}</p><br>
								<!-- <p>Director General - Ministry of Education and Culture<br>>> {[person]}</p> -->
							</div>
						</div>
						...
						<div class="row schedule-item">
							...
							<div class="col-md-4 col-sm-5">
								...
								<div class="speaker">
									<img src="assets/frontend/img/speak/x1.jpg" alt="Cole Emmerich">
								</div>
							</div>
						...
						<!-- PanelSatu -->
						<div class="row schedule-item">
							<div class="col-md-2"><time>Session I (15.00-16.00)</time></div>
						...
						<div class="row schedule-item">
							<div class="col-md-2"><time>Session II (16.15-18.15)</time></div>
							<div class="col-md-4 col-sm-6">
								<h4>Panel I</h4>
								<p>{[theme]}</p>
							</div>
					...
					<div role="tabpanel" class="col-lg-9  tab-pane fade" id="day-3">
						...
						<div class="row schedule-item">
							<div class="col-md-0"></div>
							<div class="col-md-12 text-center"><time>Thursday, 22 August 2024</time>
						...
						<!-- PanelSatu -->
						<div class="row schedule-item">
							<div class="col-md-2"><time>Session III (09.00-11.00)</time></div>
							<div class="col-md-4 col-sm-6">
								<h4>Panel I</h4>
								<p>{[theme]}</p>
							</div>
							...
							<div class="col-md-3 col-sm-6">
								...
								<p>1. {[person]}</p>
								<p>2. {[person]}</p>
								<!-- <p>3. Martina Safitry</p>
								<p>4. Chaerol Riezal</p> -->
							</div>
						</div>
						<div class="row schedule-item">
							<div class="col-md-2 col-sm-6"><time>Session IV (11.00-13.00)</time></div>
							<div class="col-md-4 col-sm-6">
								<h4>Panel I</h4>
								<p>{[theme]}</p>
							</div>
						...
						<div class="row schedule-item">
							<div class="col-md-2"><time>Session IV (11.00-13.00)</time></div>
							<div class="col-md-4 col-sm-6">
								<h4>Panel II</h4>
								<p>{[theme]}</p>
							</div>
						...
						<!-- PanelVII -->
						<div class="row schedule-item">
							<div class="col-md-2"><time>All Session (09.00-13.00)</time></div>
							<div class="col-md-4 col-sm-6">
								<h4>Panel VII</h4>
								<p>{[theme]}</p>
							</div>
